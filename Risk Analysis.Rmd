...
CMGMV = (returnCM$BABA/100)*weightsBA[1,1]+(returnCM$BAC/100)*weightsBA[2,1]+(returnCM$PKX/100)*weightsBA[3,1]+(returnCM$USB/100)*weightsBA[4,1]+(returnCM$WFC/100)*weightsBA[5,1]
mean(CMGMV)
```

```{r}
## Return for Total Portfolio MDP
CMMDP = (returnCM$BABA/100)*weightsBA[1,2]+(returnCM$BAC/100)*weightsBA[2,2]+(returnCM$PKX/100)*weightsBA[3,2]+(returnCM$USB/100)*weightsBA[4,2]+(returnCM$WFC/100)*weightsBA[5,2]
mean(CMMDP)
```

```{r}
## Return for Total Portfolio MTD
CMMTD = (returnCM$BABA/100)*weightsBA[1,3]+(returnCM$BAC/100)*weightsBA[2,3]+(returnCM$PKX/100)*weightsBA[3,3]+(returnCM$USB/100)*weightsBA[4,3]+(returnCM$WFC/100)*weightsBA[5,3]
mean(CMMTD)
```

```{r}
## Return for Total Portfolio ERC
CMERC = (returnCM$BABA/100)*weightsBA[1,4]+(returnCM$BAC/100)*weightsBA[2,4]+(returnCM$PKX/100)*weightsBA[3,4]+(returnCM$USB/100)*weightsBA[4,4]+(returnCM$WFC/100)*weightsBA[5,4]
mean(BAERC)
```

```{r}
## Return for Total Portfolio's Comparison
CMGMVr = (mean(BAGMV)+1)^252
CMMDPr = (mean(BAMDP)+1)^252
CMMTDr = (mean(BAMTD)+1)^252
CMERCr = (mean(BAERC)+1)^252
